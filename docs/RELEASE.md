# v1.1.4: equivalent rests are accepted
...
This release also bypasses stale browser HTTP caches when installing an update, so the new grading code and page install together.

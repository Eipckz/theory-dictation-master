...
export function validateBackup(data){
 ...
 for(const a of data.attempts){check(a);if(a.result)a.result=grade(a.target,{...a.target,events:a.answer},a.policy.rhythmOnly);a.fingerprint=fingerprint(a.target);}if(data.session)check(data.session);
 return clone(data);
}
